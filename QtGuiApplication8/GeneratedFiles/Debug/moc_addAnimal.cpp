...
const QMetaObject addAnimal::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_addAnimal.data,
      qt_meta_data_addAnimal,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *addAnimal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_addAnimal.stringdata0))
        return static_cast<void*>(const_cast< addAnimal*>(this));
    if (!strcmp(_clname, "Ui::Dialog_add_animal"))
        return static_cast< Ui::Dialog_add_animal*>(const_cast< addAnimal*>(this));
