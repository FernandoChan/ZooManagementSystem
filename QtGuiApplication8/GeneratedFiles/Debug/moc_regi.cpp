...
QT_MOC_LITERAL(1, 7, 18), // "getNumber_password"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 9) // "setNumber"

    },
    "regist\0getNumber_password\0\0setNumber"
};
...
void regist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getNumber_password(); break;
...
void *regist::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Dialog_register"))
        return static_cast< Ui::Dialog_register*>(const_cast< regist*>(this));
