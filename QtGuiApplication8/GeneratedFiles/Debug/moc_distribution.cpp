...
void distribution::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        distribution *_t = static_cast<distribution *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dis(); break;
        default: ;
...
const QMetaObject distribution::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_distribution.data,
      qt_meta_data_distribution,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *distribution::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_distribution.stringdata0))
        return static_cast<void*>(const_cast< distribution*>(this));
    if (!strcmp(_clname, "Ui::Dialog_des"))
        return static_cast< Ui::Dialog_des*>(const_cast< distribution*>(this));
